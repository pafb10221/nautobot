    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('key', nautobot.core.models.fields.AutoSlugField(blank=True, max_length=100, populate_from='label', unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('key', nautobot.core.models.fields.AutoSlugField(blank=True, max_length=100, populate_from='label', separator='_', unique=True)),
                ('description', models.CharField(blank=True, max_length=200)),
                ('required', models.BooleanField(default=False)),
                ('filter_logic', models.CharField(default='loose', max_length=50)),
                ('default', models.JSONField(blank=True, encoder=django.core.serializers.json.DjangoJSONEncoder, null=True)),
                ('weight', models.PositiveSmallIntegerField(default=100)),
                ...
                ('validation_regex', models.CharField(blank=True, max_length=500, validators=[nautobot.core.models.validators.ValidRegexValidator()])),
                ('advanced_ui', models.BooleanField(default=False)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('file', models.FileField(storage=nautobot.extras.models.models.database_storage, upload_to='extras.FileAttachment/bytes/filename/mimetype')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('soft_time_limit', models.FloatField(default=0, validators=[django.core.validators.MinValueValidator(0)])),
                ('time_limit', models.FloatField(default=0, validators=[django.core.validators.MinValueValidator(0)])),
                ('task_queues', nautobot.core.models.fields.JSONArrayField(base_field=models.CharField(blank=True, max_length=100), blank=True, default=list)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('result', models.JSONField(blank=True, editable=False, encoder=nautobot.core.celery.encoders.NautobotKombuJSONEncoder, null=True)),
                ('worker', models.CharField(default=None, max_length=100, null=True)),
                ('task_args', models.JSONField(blank=True, default=list, encoder=nautobot.core.celery.encoders.NautobotKombuJSONEncoder)),
                ('task_kwargs', models.JSONField(blank=True, default=dict, encoder=nautobot.core.celery.encoders.NautobotKombuJSONEncoder)),
                ('celery_kwargs', models.JSONField(blank=True, default=dict, encoder=nautobot.core.celery.encoders.NautobotKombuJSONEncoder)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('object_data_v2', models.JSONField(blank=True, editable=False, encoder=nautobot.core.celery.encoders.NautobotKombuJSONEncoder, null=True)),
            ],
            options={
                'ordering': ['-time'],
                'get_latest_by': 'time',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('source_filter', models.JSONField(blank=True, encoder=django.core.serializers.json.DjangoJSONEncoder, null=True)),
                ('destination_label', models.CharField(blank=True, max_length=50)),
                ('destination_hidden', models.BooleanField(default=False)),
                ('destination_filter', models.JSONField(blank=True, encoder=django.core.serializers.json.DjangoJSONEncoder, null=True)),
                ('advanced_ui', models.BooleanField(default=False)),
            ],
            options={
                'ordering': ['label'],
        ...
        migrations.CreateModel(
            ...
            bases=(models.Model, nautobot.extras.models.mixins.NotesMixin, nautobot.extras.models.mixins.DynamicGroupMixin),
        ),
        migrations.CreateModel(
            name='ScheduledJob',
            fields=[
                ...
                ('args', models.JSONField(blank=True, default=list, encoder=nautobot.core.celery.encoders.NautobotKombuJSONEncoder)),
                ('kwargs', models.JSONField(blank=True, default=dict, encoder=nautobot.core.celery.encoders.NautobotKombuJSONEncoder)),
                ('celery_kwargs', models.JSONField(blank=True, default=dict, encoder=nautobot.core.celery.encoders.NautobotKombuJSONEncoder)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('color', nautobot.core.models.fields.ColorField(default='9e9e9e', max_length=6)),
                ('description', models.CharField(blank=True, max_length=200)),
                ('content_types', models.ManyToManyField(limit_choices_to=nautobot.extras.utils.TaggableClassesQuery(), related_name='tags', to='contenttypes.ContentType')),
            ],
            options={
                'ordering': ['name'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('secret', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='secrets_group_associations', to='extras.secret')),
                ('secrets_group', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='secrets_group_associations', to='extras.secretsgroup')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='secrets',
            field=models.ManyToManyField(blank=True, related_name='secrets_groups', through='extras.SecretsGroupAssociation', to='extras.Secret'),
        ),
        migrations.AddField(
            model_name='secret',
            name='tags',
