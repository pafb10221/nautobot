    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('_name', nautobot.core.models.fields.NaturalOrderingField('name', blank=True, max_length=100, naturalize_function=nautobot.core.models.ordering.naturalize)),
                ('label', models.CharField(blank=True, max_length=64)),
                ('description', models.CharField(blank=True, max_length=200)),
                ('type', models.CharField(blank=True, max_length=50)),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('_name', nautobot.core.models.fields.NaturalOrderingField('name', blank=True, db_index=True, max_length=100, naturalize_function=nautobot.core.models.ordering.naturalize, null=True)),
                ...
                ('device_redundancy_group_priority', models.PositiveSmallIntegerField(blank=True, null=True, validators=[django.core.validators.MinValueValidator(1)])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('label', models.CharField(blank=True, max_length=64)),
                ('description', models.CharField(blank=True, max_length=200)),
                ('_name', nautobot.core.models.fields.NaturalOrderingField('name', blank=True, max_length=100, naturalize_function=nautobot.core.models.ordering.naturalize_interface)),
                ('type', models.CharField(max_length=50)),
                ('mgmt_only', models.BooleanField(default=False)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('napalm_args', models.JSONField(blank=True, encoder=django.core.serializers.json.DjangoJSONEncoder, null=True)),
                ('description', models.CharField(blank=True, max_length=200)),
            ],
            options={
                'ordering': ['name'],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('voltage', models.SmallIntegerField(default=120, validators=[nautobot.core.models.validators.ExclusionValidator([0])])),
