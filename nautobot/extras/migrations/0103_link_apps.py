...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='config_contexts', to='extras.configcontextschema'),
        ),
        migrations.AddField(
            model_name='configcontext',
            name='device_redundancy_groups',
            field=models.ManyToManyField(blank=True, related_name='_extras_configcontext_device_redundancy_groups_+', to='dcim.DeviceRedundancyGroup'),
        ),
        migrations.AddField(
            model_name='configcontext',
            name='device_types',
        ...
        migrations.AddField(
            model_name='configcontext',
            name='locations',
            field=models.ManyToManyField(blank=True, related_name='_extras_configcontext_locations_+', to='dcim.Location'),
        ),
        migrations.AddField(
            model_name='configcontext',
            name='owner_content_type',
            field=models.ForeignKey(blank=True, default=None, limit_choices_to=nautobot.extras.utils.FeatureQuery('config_context_owners'), null=True, on_delete=django.db.models.deletion.CASCADE, related_name='config_contexts', to='contenttypes.contenttype'),
        ),
        migrations.AddField(
            model_name='configcontext',
            name='platforms',
        ...
        migrations.AddField(
            ...
            name='content_type',
            field=models.ForeignKey(limit_choices_to=nautobot.extras.utils.FeatureQuery('custom_fields'), on_delete=django.db.models.deletion.CASCADE, related_name='computed_fields', to='contenttypes.contenttype'),
        ),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['request_id', 'changed_object_type_id', 'changed_object_id'], name='extras_objectchange_triple_idx'),
        ),
        migrations.AddIndex(
            model_name='objectchange',
